            ...
            <nav className="flex flex-wrap items-center justify-between p-7 bg-gray-900">
              <div className="flex items-center space-x-4 ">
                <img
                  src="n.png"
                  alt="Contact Icons"
                  className="w-[310px] flex  cursor-pointer  h-auto absolute right-10
    sm:  "
                />
                {/* <!-- Other nav items --> */}
              </div>
            ...
            <nav className="flex flex-wrap justify-end p-20">
              <img
                className="absolute flex flex-wrap left-0 -translate-y-6"
                src="weblogo2.jpg"
                alt=""
              />

              <img
                className="cursor-pointer flex flex-wrap mx-10"
                src="f18.png"
                alt=""
              />
            </nav>
